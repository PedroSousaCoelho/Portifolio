        ...
        <section class = "min-h-screen">
            <nav className='py-10 mb-12 flex justify-between'>
              ...
              <ul className='flex items-center'>
                ...
                <li><a href="https://drive.google.com/file/d/11QzzbASzL9xnp40-jlryrU07qkE1FsvZ/view?usp=sharing" target="_blank" rel="noreferrer" className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-5'>Curriculo</a></li>
              </ul>
            </nav>
